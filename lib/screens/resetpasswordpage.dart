...
class ResetPasswordPage extends StatefulWidget { // Ganti nama kelas jika perlu
  final String email;

  const ResetPasswordPage({super.key, required this.email}); // Ganti nama konstruktor jika perlu

  @override
  State<ResetPasswordPage> createState() => _ResetPasswordPageState(); // Ganti nama state jika perlu
}

class _ResetPasswordPageState extends State<ResetPasswordPage> { // Ganti nama state jika perlu
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              CustomTextField(
                label: 'Email',
                hintText: 'Email Anda', // Hint text mungkin tidak terlihat jika field terisi
              ...
              _isLoading
                  ...
                  : CustomButton( // Menggunakan CustomButton yang sudah dimodifikasi
                      text: 'Ubah Password',
